...
void print_queue_status(const PriorityQueue<T>& pq, const string& label) {
    ...
    cout << pq.toString() << endl;                                                                                  // Print detailed content using toString()
    cout << "-------------------------" << endl;
}
...
int main() {
    ...
    print_queue_status(pq_int, "Initial State");                                                                   //Print intial queue state. Should be empty.
    ...
    while (!pq_int.is_empty()) {                                                                                    //Test dequeue on a filled queue
        try {
            ...
            break;                                                                                                  // Exit loop if dequeue/peek fails. Shouldnt happen unless we have serious problems
        }
    }
    ...
    while (!pq_str.is_empty()) {
         try {
            ...
            cout << "Dequeue/Peek failed unexpectedly: " << e.what() << endl;
            break;                                                                                         // Stop the loop. This should only fail if queue is empty, but we checked if it was empty
        }
    }
